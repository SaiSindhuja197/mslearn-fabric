...
1. Click on **+ New Item** ,Seacrh and Click on **Warehouse** to create a new Warehouse.
...
1. At the top of the page in the data warehouse, select the **Model Layouts** tab. If the **Model Layouts** option doesn't show up, refresh the browser window. 
...
3. Drag the **ProductKey** field from the **FactSalesOrder** table and drop it on the **ProductKey** field in the **DimProduct** table. Then confirm the following relationship details and click on **Save (9)**:

    - **Table 1 (1)**: FactSalesOrder
    - **Column (2)**: ProductKey
    - **Table 2 (3)**: DimProduct
    - **Column (4)**: ProductKey
